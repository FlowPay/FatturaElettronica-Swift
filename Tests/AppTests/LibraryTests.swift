...
final class LibraryTests: XCTestCase {
    ...
    func testFPA01() throws{
        ...
        let url = "./Tests/AppTests/mock/FPA02.xml"
        ...
        let handle = XMLHandler().handle(data, type: .xml)
    ...
    func testFPA() throws{
        ...
        let exp = expectation(description: "Testing FPA")
        //        let path = Bundle.main.path(forResource: "./mock/PA02", ofType: "xml")!
        //        let data = try Data(contentsOf: URL(fileURLWithPath: path), options: .mappedIfSafe)
        // let url = "https://www.fatturapa.gov.it/export/documenti/fatturapa/v1.2/IT01234567890_FPA01.xml"
        
        let url = "./Tests/AppTests/mock/FPA.xml"
        ...
        handle.whenSuccess{
            print($0.fatturaElettronicaBody.datiPagamento.first?.dettaglioPagamento.first?.iban)
            XCTAssert($0.fatturaElettronicaBody.datiPagamento.first?.dettaglioPagamento.first?.iban != nil, "Should be not null")
            exp.fulfill()
        }
